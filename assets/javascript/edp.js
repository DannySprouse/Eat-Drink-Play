  ...
  $("#meal-button").on("click", function () {
    ...
    $.ajax({
      ...
      for (var i = 0; i < response.meals.length; i++) {
        ...
        $(".meal-category").html("<h5>" + "Category: " + response.meals[i].strCategory);
        $(".meal-area").html("<h5>" + "Area: " + response.meals[i].strArea);
  ...
  $("#drink-button").on("click", function () {
    ...
    $.ajax({
      ...
      for (var i = 0; i < response.drinks.length; i++) {
        ...
        $(".drink-category").html("<h5>" + "Category: " + response.drinks[i].strCategory);
        $(".drink-alcoholic").html("<h5>" + "Alcoholic: " + response.drinks[i].strAlcoholic);
        ...
        $(".card-drink-alcoholic").html("<p>" + response.drinks[i].strAlcoholic);
